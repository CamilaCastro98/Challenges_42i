...
const Challenge1 = () => {
  ...
  return (
    <>
    <div className="flex flex-col p-5 pb-8 bg-blue-500 rounded-t-sm lg:h-[350px]">
      <div>
        <h1 className="font-semibold md:text-xl">Find Pair With Sum</h1>
        <p className="text-sm md:text-base">Enter a comma-separated list of numbers and a target sum. (To input an empty array, simply enter 0).</p>
        <Formik
          ...
          {({
            ...
            <form onSubmit={handleSubmit}>
              <div className="flex flex-col px-10 mt-5 md:px-20">
                <label className="font-semibold" htmlFor="numbers">Numbers:</label>
                <input
                  id="numbers"
                  type="text"
                  name="numbers"
                ...
                />
                <div className="text-sm font-semibold text-red-800">{errors.numbers && touched.numbers && errors.numbers}</div>
              </div>
              <div className="flex flex-col px-10 mt-2 md:px-20">
                <label className="font-semibold" htmlFor="targetSum">Target:</label>
                <input
                  id="targetSum"
                  type="number"
                  name="targetSum"
                  ...
                  className="h-8 p-1 mt-2 mb-1 border-2 border-black rounded-sm"
                />
                <div className="text-sm font-semibold text-red-800">{errors.targetSum && touched.targetSum && errors.targetSum}</div>
              </div>
    ...
    <div className="px-5 py-3 font-semibold bg-blue-600 rounded-b-sm">Solution: {result}</div>
    </>
  );
};
